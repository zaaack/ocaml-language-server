...
export namespace Query {
  ...
  export const document = (name: null | string) => ({
    at: (position: Position) =>
      new Query<["document", null | string, "at", Position], string>([
        "document",
        name,
        "at",
        position,
  ...
  export namespace dump {
    export namespace env {
      export const at = (position: Position) =>
        new Query<["dump", "env", "at", Position], json.Value>([
          "dump",
          "env",
          "at",
          position,
  ...
  // errors
  export const errors = () =>
    new Query<["errors"], data.IErrorReport[]>(["errors"]);

  // locate
  export const locate = (name: null | string, kind: "ml" | "mli") => ({
    at: (position: Position) =>
      new Query<
        ["locate", null | string, ("ml" | "mli"), "at", Position],
        { file: string; pos: IColumnLine }
  ...
  export namespace occurrences {
    export namespace ident {
      export const at = (position: Position) =>
        new Query<["occurrences", "ident", "at", Position], ILocation[]>([
          "occurrences",
          "ident",
          "at",
          position,
  ...
  export const outline = () =>
    new Query<["outline"], data.Outline>(["outline"]);

  // path
  export namespace path {
    export namespace list {
      export const source = () =>
        new Query<["path", "list", "source"], string[]>([
          "path",
          "list",
          "source",
        ]);
  ...
  export namespace project {
    export const get = () =>
      new Query<["project", "get"], { result: string[] }>(["project", "get"]);
  }
  ...
  export namespace type {
    export const expression = (expr: string) => ({
      at: (position: Position) =>
        new Query<["type", "expression", string, "at", Position], string>([
          "type",
          "expression",
          expr,
          "at",
    ...
    export namespace enclosing {
      export const at = (position: Position) =>
        new Query<["type", "enclosing", "at", Position], data.IType[]>([
          "type",
          "enclosing",
          "at",
          position,
